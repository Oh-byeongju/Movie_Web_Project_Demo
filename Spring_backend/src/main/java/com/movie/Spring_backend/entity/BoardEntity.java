...
public class BoardEntity {
    ...
    public BoardEntity(Long bid, String btitle, String bdetail, Date bdate, String bcategory,Integer bclickindex, Integer blike, Integer bunlike, MemberEntity member
