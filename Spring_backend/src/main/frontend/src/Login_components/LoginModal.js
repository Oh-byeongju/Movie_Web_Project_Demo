    ...
    <>
      <Modal>
				<LoginLayout>
					...
					<ModalContents>
						<LoginId name="id" type="text" placeholder="아이디" onChange={onChange} value={id} onKeyUp={ActiveIsPassedLogin}>
						</LoginId>
						<LoginPw name="pw" type="password" placeholder='비밀번호' onChange={onChange} value={pw} onKeyUp={ActiveIsPassedLogin}>
						</LoginPw>
						<LoginMid>
						...
						<SocialBox>
							<button className="kakao">
								<img alt="kakao" className="kakaoLogo" src="/img/login/kakao.jpg"/>
								<div className="kakaoText">
									카카오 계정으로 신규가입
								</div>
							</button>
							<button className="facebook">
								<img alt="facebook" className="facebookLogo" src="/img/login/facebook.png"/>
