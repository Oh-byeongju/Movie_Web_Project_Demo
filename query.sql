...
INSERT INTO `movie`(`mtitle`, `mdir`, `mgenre`, `mtime`, `mdate`, `mrating`, `mstory`, `mimagepath`)
VALUES("더 퍼스트 슬램덩크", "이노우에 다케히코" , "애니메이션", "124", "20230104", "12", '<h2><span style="color: rgb(51, 51, 51);">전국 제패를 꿈꾸는 북산고 농구부 5인방의 꿈과 열정, </span></h2><h2><span style="color: rgb(51, 51, 51);"><span class="ql-cursor">﻿</span>멈추지 않는 도전을 그린 영화</span></h2>',"img/ranking/2.jpg");
